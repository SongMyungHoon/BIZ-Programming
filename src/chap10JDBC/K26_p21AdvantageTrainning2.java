...
public class K26_p21AdvantageTrainning2 {

	public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {		
		K26_DAO2 k26_dao = new K26_DAO2();
...
class K26_DAO2 {
	...
	public void k26_setTableName(String k26_tableName) {
		K26_DAO2.k26_tableName = k26_tableName;
	}
...
//				+ "/practice?serverTimezone=UTC", "root", "qortjf90");
	...
	public void k26_connectDB () {
		...
		String k26_useDB_URL_Option = k26_stringBuilder.append("?rewiteBatchedStatements=true&useUnicode=true&characterEncoding=utf8")
					.append("&useCursorFetch=true").append("&serverTimezone=Asia/Seoul&allowPublicKeyRetrieval=true")
...
//				+ "THTSKS010H00.dat";
		...
		k26_preStatement.setFetchSize(5000);
		
		long start = System.currentTimeMillis();
		long startInternal = System.currentTimeMillis();
		long startInternal10 = System.currentTimeMillis();
		int batchSize = 10000;
		while((k26_readTxt = k26_bufferedReader.readLine()) != null) {
			String[] k26_field = k26_readTxt.split("%_%");
...
//				}				
				if(k26_cnt % batchSize == 0 && k26_cnt != 0) {
