...
public class K26_p7Receipt1 {
	...
	public static void main(String[] args) {
		...
		int k26_totalPrice = k26_orderPrice - k26_discountVal - k26_point - k26_taxFreeVal;
		...
		System.out.printf("승 인 금 액 : %.28s\n", k26_dFormat.format(k26_receipt));	// 42-14 = 28
		System.out.printf("가 맹 번 호 : 730461774%2s/%2s비씨카드사\n", " ", " ");
		System.out.printf("사업자 번호 : 129-17-77924\n");
		System.out.printf("------------------------------------------\n");
		/*----------------- </Body> -----------------*/
		/*----------------- <Tail> -----------------*/
		System.out.printf("%s%2sCASHIER :%13.13s\n"	// 전체 가로 길이 : 42
