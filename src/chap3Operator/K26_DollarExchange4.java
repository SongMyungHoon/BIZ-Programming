...
public class K26_DollarExchange4 {
	...
	public static void main(String[] args) {
		...
		// Header 부분 출력
		System.out.printf("*************************************************************************\n");
		System.out.printf("*%24s(정확한)수수료 적용환전%24s*\n"," "," ");
		
		// 정수형 처리한 총 수수료, 환전 결과 받은 달러, 달러당 환전 수수료 출력
		...
		// 환전하기 위해 가져온 원화, 환전 결과 받은 달러, 정수형으로 처리한 총 수수료, 잔돈 출력
