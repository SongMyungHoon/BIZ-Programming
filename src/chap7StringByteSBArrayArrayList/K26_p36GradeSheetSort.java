...
class K26_p36OneRec {
	...
	public K26_p36OneRec(int student_id, String k26_name
...
public class K26_p36GradeSheetSort {
	...
	static ArrayList<K26_p36OneRec> k26_ArrayOneRec = new ArrayList<>();
	...
	public static void main(String[] args) {
		k26_dataSet();			// K26_p36OneRec type data를 선언하고 field 값을 임의로 저장
		k26_dataSort();			// 생성한 data를 총점 기준으로 sort
	...
	public static void k26_dataSet() {
		for(int k26_i = 0; k26_i < k26_iPerson; k26_i++) {
			...
			k26_ArrayOneRec.add(new K26_p36OneRec(k26_i,k26_name,k26_kor,k26_eng,k26_mat)); 
		}	// for loop end
	...
	public static void k26_itemPrint(int k26_i) {
		K26_p36OneRec k26_record;	// K26_OneRec class type instance 선언
...
}	// K26_p36GradeSheetSort Class end
