...
public class K26_p24ArrayMinSearch {
	...
	public static void main(String[] args) {
		...
		// iArray의 값 중 가장 작은 값을 저장하기 위한 정수형 변수 선언
		int k26_iMin = k26_iArray[0];
		
		// iArray의 값중 가장 작은 값의 index를 저장할 정수형 변수 선언
		int k26_iMinPt = 0;
		
		// iArray의 length 만큼 for loop의 반복 조건을 설정
		for(int k26_i = 0; k26_i < k26_iArray.length; k26_i++) {
			
			// 앞쪽 index의 element 중 가장 작은 값보다 현재 값이 작은 경우 iMin 값 변경
			if(k26_iMin > k26_iArray[k26_i]) {
				k26_iMin = k26_iArray[k26_i];
				k26_iMinPt = k26_i;	// 해당 element의 index값 저장
			}	// if end
		}	// for loop end
		
		// iMinPt, iMin 값 console에 출력
		System.out.printf("MIN : iArray[%d] = %d\n", k26_iMinPt, k26_iMin);
		
	}	// main method end
}	// K26_p24ArrayMinSearch Class end
